...
public sealed class Nfs4CompoundArgs : IXdrSerializable<Nfs4CompoundArgs>
{
    ...
    private static Nfs4ArgOp DecodeArgOp(Nfs4Op op, ref XdrReader reader) => op switch
    {
        ...
        Nfs4Op.Commit => new Nfs4CommitOp { Offset = reader.ReadUInt64(), Count = reader.ReadUInt32() },
        ...
        Nfs4Op.Link => new Nfs4LinkOp { NewName = reader.ReadString(Nfs4.MaxNameLength) },
        Nfs4Op.OpenAttr => new Nfs4OpenAttrOp { CreateDirectory = reader.ReadBool() },
...
public sealed class Nfs4CompoundResult : IXdrSerializable<Nfs4CompoundResult>
{
    ...
    private static Nfs4ResOp CreateResOp(Nfs4Op op) => op switch
    {
        ...
        Nfs4Op.Commit => new Nfs4CommitResult(),
        ...
        Nfs4Op.Link => new Nfs4LinkResult(),
